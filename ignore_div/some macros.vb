Sub ГЌГ®ГўГ»Г©Г‘ГЇГЁГ±Г®ГЄ()
'
' ГЌГ®ГўГ»Г©Г‘ГЇГЁГ±Г®ГЄ ГЊГ ГЄГ°Г®Г±
' ГЌГ®ГўГ»Г© Г±ГЇГЁГ±Г®ГЄ
' 
'
    With ListGalleries(wdOutlineNumberGallery).ListTemplates(1).ListLevels(1)
        ...
        With .Font
            ...
            .Name = ""
        End With
        .LinkedStyle = "Г‡Г ГЈГ®Г«Г®ГўГ®ГЄ 1"
    End With
    With ListGalleries(wdOutlineNumberGallery).ListTemplates(1).ListLevels(2)
        ...
        With .Font
            ...
            .Name = ""
        End With
        .LinkedStyle = "Г‡Г ГЈГ®Г«Г®ГўГ®ГЄ 2"
    End With
    With ListGalleries(wdOutlineNumberGallery).ListTemplates(1).ListLevels(3)
        ...
        With .Font
            ...
            .Name = ""
        End With
        .LinkedStyle = "Г‡Г ГЈГ®Г«Г®ГўГ®ГЄ 3"
    End With
    With ListGalleries(wdOutlineNumberGallery).ListTemplates(1).ListLevels(4)
        ...
        With .Font
            ...
            .Name = ""
        End With
        .LinkedStyle = "Г‡Г ГЈГ®Г«Г®ГўГ®ГЄ 4"
    End With
...
End Sub
Sub Г‘ГЇГЁГ±Г®ГЄГ’ГЁГ°ГҐ()
'
' Г‘ГЇГЁГ±Г®ГЄГ’ГЁГ°ГҐ ГЊГ ГЄГ°Г®Г±
'
'
...
End Sub
Sub Г’Г ГЎГ«ГЁГ¶Г Г’ГҐГ±ГІ()
'
' Г’Г ГЎГ«ГЁГ¶Г Г’ГҐГ±ГІ ГЊГ ГЄГ°Г®Г±
'
'
    ...
    With Selection.Tables(1)
        If .Style <> "Г‘ГҐГІГЄГ  ГІГ ГЎГ«ГЁГ¶Г»" Then
            .Style = "Г‘ГҐГІГЄГ  ГІГ ГЎГ«ГЁГ¶Г»"
        End If
    ...
    End With
    Selection.TypeText Text:="ГґГ»Гў"
End Sub
Sub MainHeading()
'
' MainHeading ГЊГ ГЄГ°Г®Г±
'
'
...
'
' ListHeading2AfterHead ГЊГ ГЄГ°Г®Г±
'
'
...
'
' ListHeading2AfterText ГЊГ ГЄГ°Г®Г±
'
'
...
'
' ListHeading3AfterHead ГЊГ ГЄГ°Г®Г±
'
'
...
'
' ListHeading3AfterText ГЊГ ГЄГ°Г®Г±
'
'
...
'
' ImageNumberParagraph ГЊГ ГЄГ°Г®Г±
'
'
...
'
' TableNumberParagraph ГЊГ ГЄГ°Г®Г±
'
'
...
'
' AfterTableBeforeText ГЊГ ГЄГ°Г®Г±
'
'
...
'
' AfterTableBeforeHeading ГЊГ ГЄГ°Г®Г±
'
'
